    ...
    return (
        <main className='relative max-w-screen-2xl mx-auto px-4 py-4 md:py-12 text-black '>
            <div className=' flex flex-col md:flex-row min-h-[400px] max-w-screen-lg m-auto rounded-3xl shadow-xl'>
                ...
                <div className='w-full flex flex-col justify-start items-center flex-1 px-4 py-8 bg-white rounded-b-3xl md:rounded-e-3xl md:rounded-s-none'>
                    <div className='w-[90%] sm:w-[80%] max-w-[400px] md:py-4'>
            ...
            <Circle customeStyle='bg-[#A1F6DD] right-0 lg:right-40 bottom-24' />
        </main>
    )
}
