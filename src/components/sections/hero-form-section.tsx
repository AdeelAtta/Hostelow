...
const HeroFormSection = () => {
    return (
        <div className='flex flex-col md:flex-row justify-center items-center gap-y-8'>
            <div className=''>
                <h1 className="max-w-2xl mb-4 text-3xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-6xl dark:text-white">Built for ambitious,forward thinking <span className='bg-yellow-400'>investors</span></h1>
