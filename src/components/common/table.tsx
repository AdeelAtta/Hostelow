            ...
            <div className="overflow-x-auto rounded-t-lg">
                <table className="min-w-full divide-y-2 divide-gray-200 bg-white text-sm">
                    <thead className="ltr:text-left rtl:text-right">
                        <tr>
                            {tableData.header.length > 0 && tableData.header.map((column: TableColumn, index) => <th key={column.text} className="whitespace-nowrap px-4 py-2 font-bold text-white">{column.text}</th>)}
                        </tr>
                    </thead>
