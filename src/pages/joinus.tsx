            ...
            <div className='flex flex-col md:flex-row justify-center items-center gap-y-8 bg-[#4645454e] py-6'>
                <div className=''>
                    ...
                    <div className='flex justify-start'>
                        ...
                        <a href="#" className="inline-flex items-center justify-center px-2 md:px-5 py-2 md:py-3 text-sm font-medium text-center text-gray-100 border border-gray-300 rounded-lg hover:bg-[#ffffff4e] focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                            Speak to Sales
                        </a>
                    </div>
                </div>
