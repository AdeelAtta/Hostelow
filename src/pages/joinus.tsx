    ...
    return (
        <section className="mx-auto max-w-screen-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16 bg-black">
            <div className='flex flex-col md:flex-row justify-center items-center gap-y-8'>
                <div className=''>
                    <h1 className="max-w-2xl mb-4 text-3xl font-extrabold tracking-tight leading-none md:text-4xl xl:text-6xl dark:text-white">Welcome to the Hostelow Marketplace</h1>
                    <p className="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Unlock new possibilities – showcase your unique hostel on our platform and welcome global travelers today!</p>
